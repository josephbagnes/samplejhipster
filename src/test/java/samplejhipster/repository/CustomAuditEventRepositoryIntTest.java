package samplejhipster.repository;

import samplejhipster.SamplejhipsterApp;
import samplejhipster.config.Constants;
import samplejhipster.config.audit.AuditEventConverter;
import samplejhipster.domain.PersistentAuditEvent;
...
import static samplejhipster.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
